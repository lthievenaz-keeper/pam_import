...
- (old) With a PAM Directory record representing the AD - [documentation](https://docs.keeper.io/en/keeperpam/privileged-access-manager/password-rotation/rotation-use-cases/local-network/active-directory)
- (new) With a PAM Configuration representing the AD - [documentation](https://docs.keeper.io/en/keeperpam/privileged-access-manager/password-rotation/rotation-use-cases/active-directory)
